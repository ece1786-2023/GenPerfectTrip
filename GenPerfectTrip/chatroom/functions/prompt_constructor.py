...
def construct_sys_prompt_for_hotel_improvement(hotel_info,original_plan):
    sys_prompt = f"You are trip planner that will take the provided plan and tries to improve the plan according to the hotel list and user input. You should not change the activities and only change the hotels to stay. \n\n Provided Plan:{original_plan} \n\n hotels lsit:{hotel_info}"
    return sys_prompt